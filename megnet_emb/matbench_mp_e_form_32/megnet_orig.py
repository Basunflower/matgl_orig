...
parser.add_argument('--dim_node_embed', type=int, default=32, help='number of node embedding dim')
...
if __name__ == '__main__':
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            #     mode='min')
            # Training
            trainer = pl.Trainer(max_epochs=1000, default_root_dir=task.dataset_name+"_32_lightning_logs/")  # , callbacks=[checkpoint_callback])
