...
parser.add_argument('--dim_node_embed', type=int, default=1, help='number of node embedding dim')
...
parser.add_argument('--cuda_devices', type=str, default='3', choices=['0', '1', '2', '3', '4'],
...
if __name__ == '__main__':
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            # Training
            trainer = pl.Trainer(max_epochs=100, default_root_dir=task.dataset_name+"_"+str(fold)+"_"+str(args.dim_node_embed)+"/")  # , callbacks=[checkpoint_callback])
