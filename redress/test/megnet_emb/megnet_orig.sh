...
echo "Embedding Running with dim_node_embed = $dim fold = $fold  cuda_device = $cuda_device"
python megnet_orig.py --dim_node_embed "$dim" --fold "$fold" --cuda_devices "$cuda_device"
